        ...
        <Grid
          ...
          <Grid item xs={12}>
            <Announcement title='دوره آموزش مقدماتی پایتون، به همراه حل مسئله' date='۱۷ آبان ۱۴۰۰' image='announcement.jpg'
              text='دوره‌ی آموزش مقدماتی پایتون، یک دوره‌ی آموزش برنامه‌نویسی مخصوص دختران و با رویکرد حل مسئله‌ست که زیر نظر کارسوق ریاضی مهرگان برگزار می‌شود و مدرسین آن، دو نفر از کارسوقی‌های فقید (زهرا رمضانی و نگار نادیان) هستند. برای ثبت‌نام و شرکت در این دوره به بخش «آزمون‌ها» مراجعه کنید.' />
          </Grid>
