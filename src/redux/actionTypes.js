...
export const SET_STUDENT_STATUS_REQUEST = 'SET_STUDENT_STATUS_REQUEST';
export const SET_STUDENT_STATUS_SUCCESS = 'SET_STUDENT_STATUS_SUCCESS';
export const SET_STUDENT_STATUS_FAILURE = 'SET_STUDENT_STATUS_FAILURE';
