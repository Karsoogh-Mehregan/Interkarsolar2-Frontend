...
exports.logout = exports.login = exports.createAccount = void 0;

var _api = require("../middleware/api/api");
...
var createAccount = function createAccount(_ref) {
  ...
  return _defineProperty({}, _api.CALL_API, {
    types: [actionTypes.CREATE_ACCOUNT_REQUEST, actionTypes.CREATE_ACCOUNT_SUCCESS, actionTypes.CREATE_ACCOUNT_FAILURE],
