  ...
  return (
    <Container style={{ overflow: 'hidden' }}>
      ...
      >
        ...
        >
          <Grid item xs={12}>
            <Announcement title='آغاز ثبت‌نام مرحله یک' date='۲۵بهمن۹۹' image='logo.png' text='بله! بعد از یک سال دوری از شما سیارک‌داران گرامی، دوباره با دوره‌ی دوم رویداد اینترکارسولار در خدمت شما هستیم! ثبت‌نام اینترکارسولار از امروز شروع شده و تا اول اسفند ادامه داره. بدو جا نمونی... ' />
          </Grid>
          {!isRegistered &&
            <Grid item xs={12}>
